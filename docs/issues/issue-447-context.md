...
Parent #442 is a planning/spec traceability slice in this backend repository. The underlying UI work in the chain (sidebar/navigation) is implemented in the client repository.
