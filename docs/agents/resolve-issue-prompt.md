# Resolve Issue → PR prompt (extracted)

This is the **extracted issue-resolving prompt** from the AIAgentExpert training, separated from the teacher course/chat export.
